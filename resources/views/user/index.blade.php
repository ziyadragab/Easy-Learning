            ...
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="banner__content">
                        ...
                        <a href="{{ route('endUser.showAbout') }}" class="btn banner__btn wow fadeInUp" data-wow-delay=".6s">more about me</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row gx-0 services__active">
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src={{ asset("userAssets/img/images/services_img01.jpg") }} alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src={{ asset("userAssets/img/icons/services_light_icon01.png") }} alt="">
                                <img class="dark" src={{ asset("userAssets/img/icons/services_icon01.png") }} alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src={{ asset("userAssets/img/images/services_img02.jpg") }} alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src={{ asset("userAssets/img/icons/services_light_icon02.png") }} alt="">
