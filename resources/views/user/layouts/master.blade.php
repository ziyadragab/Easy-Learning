                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="menu__wrap">
                            <nav class="menu__nav">
                                <div class="logo">
                                    <a href="index.html" class="logo__black"><img src={{
                                            asset("userAssets/img/logo/logo_black.png") }} alt=""></a>
                                    <a href="index.html" class="logo__white"><img src={{asset
                                            ("userAssets/img/logo/logo_white.png") }} alt=""></a>
                                </div>
                                <div class="navbar__wrap main__menu d-none d-xl-flex">
                                    <ul class="navigation">
                                        ...
                                        <li class="menu-item-has-children"><a
                                                href="{{ route('endUser.showPortfolio') }}">Portfolio</a></li>
                                        ...
                                        <li class="menu-item-has-children"><a href="#">Language</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li> <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                                        ...
                                                        onclick="setLocaleAndSubmit('{{ $localeCode }}');">
                                ...
                                <div class="header__btn d-none d-md-block">
                                    <a href="{{ route('endUser.contact.create') }}" class="btn">Contact me</a>
                                </div>
                            </nav>
                        </div>
                        <!-- Mobile Menu  -->
                            ...
                            <nav class="menu__box">
                                ...
                                <div class="nav-logo">
                                    <a href="index.html" class="logo__black"><img
                                            src={{asset("userAssets/img/logo/logo_black.png")}} alt=""></a>
                                    <a href="index.html" class="logo__white"><img
                                            src={{asset("userAssets/img/logo/logo_white.png")}} alt=""></a>
                                </div>
